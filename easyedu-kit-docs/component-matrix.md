...
| Navigation Skeleton | Student Management and Mass Import loading surfaces | `components/_navigation-skeleton.scss`, `docs/components/navigation-skeleton.md` | done | `EED-UI-2026-SKELETON-B-K2-FINAL` pins converged K2 provenance. Outer frames stay static; only decorative internal cues animate with RTL, reduced-motion and forced-colors safeguards. |
