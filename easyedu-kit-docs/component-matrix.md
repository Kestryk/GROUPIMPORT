...
| Loading/skeletons | `templates/manage.mustache`, `index.php`, `scss/components/_layout.scss`, `scss/views/_mass-import.scss` | `components/_loading.scss`, `docs/components/loading.md` | partial | Shared surfaces, cue shimmers, logical K2 section borders and opacity handoff are reusable; readiness, fail-open timing and page geometry remain consumer-owned. |
| Navigation Skeleton | Student Management and Mass Import loading surfaces | `components/_navigation-skeleton.scss`, `docs/components/navigation-skeleton.md` | done | `EED-UI-2026-SKELETON-B-K2-FINAL-I` pins converged K2 provenance. Outer frames stay static; only decorative internal cues animate with RTL, reduced-motion and forced-colors safeguards. |
