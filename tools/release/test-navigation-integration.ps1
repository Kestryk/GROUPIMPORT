...
$groupingRailAudit = Read-RequiredFile 'tools/playwright/grouping-rail-containment.spec.js'
...
Assert-Contains 'scss/responsive/_mobile.scss' (Read-RequiredFile 'scss/responsive/_mobile.scss') 'is-expanded::after' 'responsive Grouping rail must keep an expanded-state containment override'
Assert-Contains 'scss/responsive/_mobile.scss' (Read-RequiredFile 'scss/responsive/_mobile.scss') 'left:\s*0;' 'responsive Grouping rail must paint inside the card identity slot'
Assert-Contains 'scss/responsive/_mobile.scss' (Read-RequiredFile 'scss/responsive/_mobile.scss') 'identity-border-width\) / 2' 'responsive Grouping rail icon must stay inside the card identity slot'
Assert-Contains 'grouping-rail-containment.spec.js' $groupingRailAudit 'rail left edge stays in the card' 'focused Grouping rail scenario must preserve rail containment coverage'
