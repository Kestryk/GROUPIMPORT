...
if ($structure -notmatch '(?s)&-tree__section--ungrouped \{.*?--local-groupimport-easystud-ungrouped: #79506f;.*?identity-rail\(var\(--local-groupimport-easystud-icon-ungrouped\)\).*?&\.is-expanded:focus-within \{.*?card-focus-context' -or
